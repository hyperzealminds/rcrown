    ...
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-16">
      ...
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <p className="text-base text-brand-charcoal/80 leading-relaxed">
          The ultimate 3-month certification program bundling makeup, beauty styling, and professional hair &amp; nail modules. Built for aspiring beauty entrepreneurs.
        </p>
      </div>
        ...
        <div className="space-y-8">
          ...
          <div className="p-5 border border-brand-gold/15 bg-white space-y-4 shadow-sm">
            ...
            <div className="flex items-center space-x-3 text-xs text-brand-charcoal">
              ...
              <div>
                <p className="font-semibold uppercase tracking-wider">Included Free</p>
                <p className="text-[#6E6E6E]">₹25k Hair Kit, Hair &amp; Nail Courses</p>
              </div>
            </div>
          </div>
